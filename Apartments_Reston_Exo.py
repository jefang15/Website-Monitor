...
def create_blank_spreadsheets(floor_plan:str):
    ...
    df.to_excel('Output - Exo Spreadsheets/Exo {}.xlsx'.format(floor_plan), index=False)
...
list_of_dicts = [dict_a1, dict_a1a, dict_a2a, dict_a2b, dict_a2c, dict_a3, dict_a5, dict_a6, dict_a6a]
...
url_home = 'https://exoreston.com/floorplans/a2a/#detail-view'
df_home = view_html(url_home)
print(tabulate(df_home, tablefmt='psql', numalign='right', headers='keys', showindex=False))
